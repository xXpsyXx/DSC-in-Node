#define AppName "DSC Backend Service"
#define AppVersion "1.0.0"
#define ServiceName "DSCBackendService"

[Setup]
AppId={{A5D0FC8C-E07E-4B17-81B2-0F6A5CC2A2D3}
AppName={#AppName}
AppVersion={#AppVersion}
DefaultDirName={autopf}\DSCBackend
DefaultGroupName={#AppName}
OutputDir=output
OutputBaseFilename=DSCBackendSetup-advanced
Compression=lzma
...
[Icons]
Name: "{autoprograms}\DSC Backend Service Status"; Filename: "{cmd}"; Parameters: "/k sc query {#ServiceName}"
